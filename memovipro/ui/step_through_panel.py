...
class StepThroughPanel(QWidget):
    ...
    def __init__(
        ...
        self.title_label = QLabel(f"🐞  Depuración paso a paso · {macro.nombre}")
        ...
        atajos = ("<b>F8</b> siguiente · <b>F7</b> atrás · <b>F6</b> continuar<br>"
                  "<b>F4</b> saltar · <b>F12</b> repetir · <b>F9</b> parar")
        if n_bp:
            ayuda = f"Reproduciendo hasta el primer punto…<br>{atajos}"
        else:
            ayuda = f"{atajos}<br><i>Las teclas funcionan con la otra aplicación delante.</i>"
        ...
        self.back_btn.setToolTip("Volver al paso anterior  (F7 o ←)")
        self.back_btn.clicked.connect(self._on_back)
        btns.addWidget(self.back_btn)
        self.next_btn = QPushButton("▶  Siguiente")
        self.next_btn.setObjectName("next")
        self.next_btn.setToolTip("Ejecutar este paso y parar en el siguiente  (F8 o →)")
        self.next_btn.clicked.connect(self._on_next)
        btns.addWidget(self.next_btn)
        self.cont_btn = QPushButton("▶▶  Continuar")
        self.cont_btn.setObjectName("cont")
        self.cont_btn.setToolTip("Seguir sin parar hasta el próximo punto de análisis  (F6)")
        self.cont_btn.clicked.connect(self._on_continue)
        btns.addWidget(self.cont_btn)
        self.stop_btn = QPushButton("⏹  Parar")
        self.stop_btn.setObjectName("stop")
        self.stop_btn.setToolTip("Terminar la sesión de depuración  (F9)")
        ...
        self.skip_btn.setToolTip("Pasar al siguiente SIN ejecutar este  (F4)")
        self.skip_btn.clicked.connect(self._on_skip)
        btns2.addWidget(self.skip_btn)
        self.repeat_btn = QPushButton("🔁  Repetir")
        self.repeat_btn.setObjectName("repeat")
        self.repeat_btn.setToolTip("Volver a ejecutar este mismo paso, sin avanzar  (F12)")
        ...
        self.record_btn.setToolTip("Grabar pasos nuevos aquí: insertar antes, después o reemplazar")
        ...
        self.edit_btn.setToolTip("Abrir MemoviPro para editar la tabla sin cerrar esta sesión")
